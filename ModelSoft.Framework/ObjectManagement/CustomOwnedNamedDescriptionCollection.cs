...
{
  class CustomOwnedNamedDescriptionCollection<TItem, TItemImpl, TOwner> :
    CustomOwnedDescriptionCollection<TItem, TItemImpl, TOwner>,
    ...
    where TOwner : class
  {
    ...
    public CustomOwnedNamedDescriptionCollection(TOwner _Owner, string _CollectionName)
