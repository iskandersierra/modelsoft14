/*
 * Source: http://intervaltree.codeplex.com/
 */
...
using ModelSoft.Framework.DataStructures.Collections;

namespace ModelSoft.Framework.DataStructures.Trees.IntervalTree
{
  /// <summary>
